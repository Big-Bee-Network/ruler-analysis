...
Species used in this analysis ranged in body size and hariness. Those species are *Lasioglossum incompletum* (Halictidae), *Lasioglossum sisymbrii* (Halictidae), *Osmia brevis* (Megachilidae), *Ceratina arizonensis* (Apidae), *Xylocopa varipuncta* (Apidae), *Anthophora californica* (Apidae), *Hylaeus polifoli* (Colletidae), *Megachile fidelis* (Megachilidae), *Andrena chlorogaster* (Andrenidae), *Peponapis pruinosa* (Apidae), *Calliopsis* sp. (Andrenidae), *Bombus melanopygus*, *B. sonorus*, *B. vosnesenskii* (Apidae), *Agapostemon texanus* (Halictidae), *Sphecodes* sp. (Halictidae), *Augochlorella pomoniella* (Halictidae), *Xeromelecta californica* (Apidae), *Trachusa perdita* (Megachilidae), *Colletes* sp. (Colletidae)
