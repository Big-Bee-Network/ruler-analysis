...
An important component of the starting phases of the big BEE project is the formulation of a consistent protocol by which every participant will abide. As part of this protocol, we needed to determine which measurement method would be both accessible, accurate and precise for all participants. For this reason, we performed an initial assessment of five standard rulers using a microscope reticle as a comparison.
